...
| S7b | 5b | Apply S7a pattern to remaining 6 admin routes (`prompts`, `users`, `circulars`, `scraper`, `uploads`, `heatmap`) + `components/admin/Heatmap.tsx`; Playwright admin visual regression spec | Pending |
