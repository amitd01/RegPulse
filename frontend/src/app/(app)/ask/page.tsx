                  ...
                  {turns.map((turn, index) => (
                    <div key={turn.clientId} className="space-y-4">
                      ...
                      <AnswerView
                        ...
                        creditBalance={
                          index === turns.length - 1 ? turn.state.creditBalance : undefined
                        }
                        onFeedback={
                          turn.state.status === "done" && turn.state.questionId
                            ? (data) =>
                                handleFeedback(turn.clientId, turn.state.questionId!, data)
                            : undefined
                        }
                        isFeedbackSubmitting={submittingFeedbackTurn === turn.clientId}
                        feedbackSubmitted={
